...
public class tipo_producto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Formulario Tipo de Producto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
    ...
    private void generar_codigo(){
        ...
        try {
            String sql = "SELECT COALESCE (MAX(cod_tipo_prod),0)+1 AS cod FROM tipo_producto;"; // Creamos la consulta SQL.
    ...
    private void validar_descripcion(){
        ...
        try {
            ...
            rs = con.Listar("SELECT * FROM tipo_producto WHERE t_p_descrip = '" + descripcion + "'");
            boolean encontro = rs.next();
            if (encontro == true){
                JOptionPane.showMessageDialog(this, "La descripción del producto '" + descripcion 
    ...
    private void cargar_tabla(){
        ...
        try {
            ...
            while(rs.next()){
                fila[0] = rs.getString("cod_tipo_prod");
                fila[1] = rs.getString("t_p_descrip");
                cursor.addRow(fila);
            }
        } catch (SQLException ex) {
            Logger.getLogger(tipo_producto.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private boolean buscar(){
        ...
        try {
            ...
            String sql = "SELECT t_p_descrip as tipo_producto FROM tipo_producto WHERE cod_tipo_prod = " + codigo;
            System.out.println(sql);
            rs = con.Listar(sql);
            //rs.next();
            if (!rs.next()) {
                ...
                //rs.next();
                String resultado = rs.getString("tipo_producto");
    ...
    private void buscador(){
        ...
        try {
            ...
            while (rs.next()){
                fila1[0] = rs.getString("cod_tipo_prod");
                fila1[1] = rs.getString("t_p_descrip");
                cursor.addRow(fila1);
            }
        } catch (SQLException ex) {
            Logger.getLogger(tipo_producto.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void imprimir(){
        ...
        try {
            ...
            // Cargamos el reporte
            URL url = getClass().getClassLoader().getResource("reportes/reporte_t_producto.jasper");
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        operacion = "eliminar";
        desa_botones(1);
        JOptionPane.showMessageDialog(this, "Ingresa el numero del tipo de producto a eliminar!");
        txtcodigo.setEnabled(true);
        txtcodigo.requestFocus();
