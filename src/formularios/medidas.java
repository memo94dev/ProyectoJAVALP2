...
public class medidas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Formulario U. de Medidas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        txtbuscar.setDescripcion("Buscar U. de Medida");
    ...
    private void generar_codigo(){
        ...
        try {
            String sql = "SELECT COALESCE (MAX(id_u_medida),0)+1 AS ID FROM u_medida;"; // Creamos la consulta SQL.
            rs = con.Listar(sql); // Utilizamos el metodo listar.
            rs.next(); // Llamar a los siguientes resultados.
            txtcodigo.setText(rs.getString("ID")); // Enviar el resultado en el campo de codigo de nuestro formulario.
    ...
    private void validar_descripcion(){
        ...
        try {
            ...
            rs = con.Listar("SELECT * FROM u_medida WHERE u_descrip = '" + descripcion + "'");
            boolean encontro = rs.next();
            if (encontro == true){
                JOptionPane.showMessageDialog(this, "La nueva unidad de medida '" + descripcion 
    ...
    private void guardar(){
        ...
        try {
            ...
            if ("agregar".equals(operacion)){
                sql = "INSERT INTO u_medida VALUES (" + codigo + ",'" + descripcion + "');";
                System.out.println(sql);
                JOptionPane.showMessageDialog(this, "Se ha insertado nueva unidad de medida: " + descripcion);
            }
            if ("modificar".equals(operacion)){
                sql = "UPDATE u_medida SET u_descrip = '" + descripcion + "' WHERE id_u_medida = " + codigo + ";";
                System.out.println(sql);
                JOptionPane.showMessageDialog(this, "Se ha modificado correctamente a: " + descripcion);
            }
            if ("eliminar".equals(operacion)){
                sql = "DELETE FROM u_medida WHERE id_u_medida = " + codigo + ";";
                System.out.println(sql);
    ...
    private void cargar_tabla(){
        ...
        try {
            ...
            while(rs.next()){
                fila[0] = rs.getString("id_u_medida");
                fila[1] = rs.getString("u_descrip");
                cursor.addRow(fila);
            }
        } catch (SQLException ex) {
            Logger.getLogger(medidas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private boolean buscar(){
        ...
        try {
            ...
            String sql = "SELECT u_descrip as medida FROM u_medida WHERE id_u_medida = " + codigo;
            System.out.println(sql);
            rs = con.Listar(sql);
            //rs.next();
            if (!rs.next()) {
                ...
                //rs.next();
                String resultado = rs.getString("medida");
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        ...
        operacion = "modificar";
        desa_botones(1);
        JOptionPane.showMessageDialog(this, "Ingresa un codigo para la medida a editar");
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        operacion = "eliminar";
        desa_botones(1);
        JOptionPane.showMessageDialog(this, "Ingresa el ID de la medida a eliminar!");
        txtcodigo.setEnabled(true);
        txtcodigo.requestFocus();
